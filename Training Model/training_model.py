...
# session to run tf operations
with tf.Session() as session:
    # initalizing global variables and layers
    ...
    print("Final training cost ", final_training_cost, "Final testing cost ",final_testing_cost)
